        ...
        >
          {features.map((feature, index) => (
            <motion.div
              ...
              className="group bg-white/80 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border border-gray-100 hover:border-primary/30 transition-all duration-300 relative overflow-hidden"
            >
              {/* Glow Effect */}
