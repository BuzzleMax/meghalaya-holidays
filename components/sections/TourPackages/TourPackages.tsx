        ...
        >
          {packages.map((pkg) => (
            <motion.div
              ...
              className="group bg-white rounded-3xl shadow-card overflow-hidden border border-gray-100 hover:border-accent/40 hover:shadow-card-hover transition-all duration-300"
            >
              {/* Image Section */}
